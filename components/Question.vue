<template>
  <div class="flex justify-center">
    <form v-if="!isResult" class="flex flex-col items-center justify-center gap-4" @submit.prevent="handleQuestionSubmit">
      ...
      <div class="text-primary font-black flex justify-between w-full px-16">
        <span>
      ...
      <h2 class="text-5xl font-black leading-relaxed text-center text-primary border-b-2 border-b-white">
        {{ question.question }}</h2>
      <div class="flex flex-col px-8 mx-auto mt-4">
        <label v-for="answer in question.answers" class="inline-flex items-center">
